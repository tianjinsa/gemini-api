...
class ScanDetector {
  ...
  blockedIPs = new Map();
  // 配置
  historyLimit = 10;   // 减少保留的历史记录数量以节省内存
  scanThreshold = 3;   // 降低扫描判定阈值，更早检测到攻击
  scanTimeWindow = 30000; // 减少到30秒以更快检测攻击模式
  blockDuration = 3600000; // 封禁1小时后自动解除，避免长期积累数据
...
class SecurityAuditLogger {
  ...
  maxRecentAlerts = 25; // 最多保留的最近告警数量
